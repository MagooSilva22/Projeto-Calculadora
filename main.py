...
# criando label esta apos a "funcao limpar a tela".
...
b_18 = Button(frame_corpo, command = caldular, text="=", width=5, height=2, bg=cor5, fg=cor2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
